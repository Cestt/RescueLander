	...
	void OnLevelWasLoaded(int level) {
		...
		if(Application.loadedLevelName == "Menu"){
			...
			UICamera.transform.FindChild("Options_Menu/Shop_Bg_01/Texts/Achievments_Text").GetComponent<ResizeText>().ChangeText  
				(Localization_Bridge.manager.GetTextValue("RescueLander.OptionsMenuAchievments"));
		...
		if(Application.loadedLevelName == "Tuto_1"){
			UICamera.transform.FindChild("Tutorial/Step1/ChatText_1").GetComponent<ResizeText>().ChangeText  
				(Localization_Bridge.manager.GetTextValue("RescueLander.Tuto1Step1"));
			UICamera.transform.FindChild("Tutorial/Step1/TapToContinue").GetComponent<ResizeText>().ChangeText  
				(Localization_Bridge.manager.GetTextValue("RescueLander.TutoTapContinue"));
			UICamera.transform.FindChild("Prompt_Menu/Shop_Bg_01/Prompt_TutoReward_1/Text_Reward2").GetComponent<ResizeText>().ChangeText  
				(Localization_Bridge.manager.GetTextValue("RescueLander.PromptTutoReward1"));
		}

		if(Application.loadedLevelName == "Tuto_2"){
			UICamera.transform.FindChild("Tutorial/Step1/Prompt_Menu_Turn/Shop_Bg_01/ChatText_2").GetComponent<ResizeText>().ChangeText  
				(Localization_Bridge.manager.GetTextValue("RescueLander.Tuto2Step1Text1"));
			
			UICamera.transform.FindChild("Tutorial/Step1/Prompt_Menu_Turn/Shop_Bg_01/ChatText_3").GetComponent<ResizeText>().ChangeText  
				(Localization_Bridge.manager.GetTextValue("RescueLander.Tuto2Step1Text2"));
			
			UICamera.transform.FindChild("Tutorial/Step1/Prompt_Menu_Turn/Shop_Bg_01/Ok_Button/Ok_Text").GetComponent<ResizeText>().ChangeText  
				(Localization_Bridge.manager.GetTextValue("RescueLander.Ok"));
			
			UICamera.transform.FindChild("Tutorial/Step2/ChatText_1").GetComponent<ResizeText>().ChangeText  
				(Localization_Bridge.manager.GetTextValue("RescueLander.Tuto2Step2"));
			
			UICamera.transform.FindChild("Tutorial/ChatText_4").GetComponent<ResizeText>().ChangeText  
				(Localization_Bridge.manager.GetTextValue("RescueLander.Tuto2Step2"));
			
			UICamera.transform.FindChild("Prompt_Menu/Shop_Bg_01/Prompt_TutoReward_2/Text_Reward3").GetComponent<ResizeText>().ChangeText  
				(Localization_Bridge.manager.GetTextValue("RescueLander.PromptTutoReward2"));

			UICamera.transform.FindChild("Tutorial/Step1/TapToContinue").GetComponent<ResizeText>().ChangeText  
				(Localization_Bridge.manager.GetTextValue("RescueLander.TutoTapContinue"));

			UICamera.transform.FindChild("Tutorial/Step2/TapToContinue").GetComponent<ResizeText>().ChangeText  
				(Localization_Bridge.manager.GetTextValue("RescueLander.TutoTapContinue"));
		}
		if(!Application.loadedLevelName.Contains("Tuto") & !Application.loadedLevelName.Contains("Menu")){
			...
			UICamera.transform.FindChild("LoseLayout/Prompt_Ads_Shield/More_PowerUps_Text").GetComponent<ResizeText>().ChangeText  
				(Localization_Bridge.manager.GetTextValue("RescueLander.LoseShiled"));


			UICamera.transform.FindChild("LoseLayout/Prompt_Ads_Shield/Button/VideoButton_Text").GetComponent<ResizeText>().ChangeText  
				(Localization_Bridge.manager.GetTextValue("RescueLander.LoseShiledFree"));

			UICamera.transform.FindChild("LoseLayout/Prompt_Ads_Shield/Button_Shield/Button_Buy/Button_Buy_Text").GetComponent<ResizeText>().ChangeText  
				(Localization_Bridge.manager.GetTextValue("RescueLander.LoseShiledBuy"));

			UICamera.transform.FindChild("LoseLayout/Reset_Button/ButtonReset_Text").GetComponent<ResizeText>().ChangeText  
				(Localization_Bridge.manager.GetTextValue("RescueLander.Retry"));

			UICamera.transform.FindChild("WinLayout/Resume/CoinCount/Collected Coins").GetComponent<ResizeText>().ChangeText  
				(Localization_Bridge.manager.GetTextValue("RescueLander.ResumeCollectedCoins"));

			UICamera.transform.FindChild("WinLayout/Resume/Reset_Button/ButtonReset_Text").GetComponent<ResizeText>().ChangeText  
				(Localization_Bridge.manager.GetTextValue("RescueLander.Retry"));

			UICamera.transform.FindChild("WinLayout/Resume/Next_Button/ButtonNext_Text").GetComponent<ResizeText>().ChangeText  
				(Localization_Bridge.manager.GetTextValue("RescueLander.Next"));

			UICamera.transform.FindChild("WinLayout/Resume/NewColor_Unlocked").GetComponent<ResizeText>().ChangeText  
				(Localization_Bridge.manager.GetTextValue("RescueLander.ResumeNewColor"));

			UICamera.transform.FindChild("WinLayout/Win_Text/Score_Resumen/New Record").GetComponent<ResizeText>().ChangeText  
				(Localization_Bridge.manager.GetTextValue("RescueLander.WinScoreRecord"));

			UICamera.transform.FindChild("WinLayout/Resume/Pic_Frame/Share_Button/ButtonShare_Text").GetComponent<ResizeText>().ChangeText  
				(Localization_Bridge.manager.GetTextValue("RescueLander.ResumeShare"));

			GameObject.Find("Perfect").transform.FindChild("Coin_Perfect_Text").GetComponent<ResizeText>().ChangeText  
				(Localization_Bridge.manager.GetTextValue("RescueLander.Perfect"));
			...
			UICamera.transform.FindChild("Anchor (LowerRight)/Button_Garage/GarageButton_Graphic/TextGarage").GetComponent<ResizeText>().ChangeText
				(Localization_Bridge.manager.GetTextValue("RescueLander.Garage"));
		}
		...
		UICamera.transform.FindChild("Prompt_Menu/Shop_Bg_01/Prompt_MoreMoney/Text_MoreCoins").GetComponent<ResizeText>().ChangeText  
			(Localization_Bridge.manager.GetTextValue("RescueLander.PromptMoreCoinsText"));
		...
		UICamera.transform.FindChild("Garage_Menu/Canvas/Shop_Bg_01/PowerUps_Menu/Button_Magnet/ButtonPowerUp_Have").GetComponent<ResizeText>().ChangeText  
			(Localization_Bridge.manager.GetTextValue("RescueLander.MenuPUYouHave"));
		UICamera.transform.FindChild("Garage_Menu/Canvas/Shop_Bg_01/PowerUps_Menu/Illustration_Magnet/Illustration_Text").GetComponent<ResizeText>().ChangeText  
			(Localization_Bridge.manager.GetTextValue("RescueLander.MenuPUMagnetDesc"));
		#endregion
		...
		UICamera.transform.FindChild("Garage_Menu/Canvas/Shop_Bg_01/Ships_Menu/Ship_Buttons_Scroll/Ship_Buttons/Button_UFLO/ButtonShip_Title").GetComponent<ResizeText>().ChangeText  
			(Localization_Bridge.manager.GetTextValue("RescueLander.MenuShipsUFLOTitle"));
