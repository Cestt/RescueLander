                ...
                if (GUI.Button(new Rect(270, y + 60, 140, 20), "Generate"))
                {
                    try
                    {
                        ...
                        else if (_etcAlphaInfos[i].AlphaFormat == 1)
                        {
                            for (int n = 0; n < color32S.Length; ++n)
                            {
                                color32S[n] = new Color32(0, srcColor32S[n].a, 0, 255);
                            }
                        }
                        else
                        {
                            for (int n = 0; n < color32S.Length; ++n)
                            {
                                color32S[n] = new Color32(0, 0, srcColor32S[n].a, 255);
                            }
                        }
                        ...
                        _etcAlphaInfos[i].AlphaTextureImporter.spriteImportMode = SpriteImportMode.None;
